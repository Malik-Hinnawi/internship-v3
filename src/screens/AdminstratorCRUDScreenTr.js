...
const AdminstratorCRUDScreenTr = ({navigation}) =>{
    ...
    return <View style = {styles.containerStyle}>
        ...
        <Text h2 style = {{textAlign: "center"}}>Admin sayfası:</Text>
        ...
        <SearchBar term = {citySearch} 
            ...
            onEndEditing = {()=>{}} 
            onTermAdd={()=>navigation.navigate("AdminstratorAddTr")}
            placeholder="Ara"
            />
            ...
            renderItem = {({item}) =>{
                if(citySearch == ""){
                    ...
                    <CityDisplay
                        id = {item.id} 
                        name ={item.name}
                        labels={{"left-label": "İl no", "right-label": "İl adı"}}
                        navigate={()=> navigation.navigate("AdminstratorRegionsTr", {"id": item.id, "cityName": item.name})}
                    />
                    )
                }
...
export default AdminstratorCRUDScreenTr;