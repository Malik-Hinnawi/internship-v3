...
const AdminstratorTownsPageTr = ({route, navigation}) =>{
    ...
    return <View style = {styles.containerStyle}>
        ...
        <Text h2 style = {{textAlign: "center"}}>Admin Şehir Sayfası:</Text>
        ...
        <View style = {{flexDirection:"row", alignSelf:"center", marginVertical: 2}}>
            <Text style = {{textAlign:"center", color: "#993737"}}>İlçe:  </Text>
        ...
        <SearchBar 
            ...
            onEndEditing = {()=>{}} 
            onTermAdd={()=> navigation.navigate("AdminstratorAddTownsTr", {id: regionId})}
            placeholder = "Ara"
            />
...
export default AdminstratorTownsPageTr;